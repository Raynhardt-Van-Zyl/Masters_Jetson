...
std::string get_tegra_pipeline(int width, int height, int fps) {
    return "nvarguscamerasrc ! nvvidconv flip-method=2 ! video/x-raw(memory:NVMM), width=1920, height=1080,format=NV12, framerate=30/1 ! nvvidconv ! video/x-raw,format=I420 ! appsink";
}
